...
public class BoltDeclarer implements Serializable {
	...
	/**
	 * If we have field-based grouping, we need to know the fields used to shard the
	 * data
	 * 
	 * @return
	 */
	...
	/**
	 * Creates (or returns) a "router" that funnels our output stream to the next
	 * destination (which might have multiple executors).
	 * 
	 * @return
	 */
